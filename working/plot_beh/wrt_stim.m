...
% seperate stage 1 from first week after stage 1 (i.e., post-surgery
% analgesia)
    ...
    for i = 1 : length(stimContacts)
        ...
        elseif strcmp('a', stimContacts{i}(1))
            ...
            if strcmp('R', stimContacts{i}(6))
                stimGroups.(stimContacts{i}) = {redcap(i_aDBS_ROn_Loff & i_s2 , :)};
    
            elseif strcmp('L', stimContacts{i}(6))
                stimGroups.(stimContacts{i}) = {redcap(i_aDBS_LOn_Roff & i_s2, :)};
...
% 
%     i_s2_one0mA_oneOff                      =  (i_L_eq0  & ~i_L_off & i_R_off & i_R_eq0) | ...
%                                            (i_R_eq0  & ~i_R_off & i_L_off & i_L_eq0) ...
%                                             & i_s2 ...
%                                         & ~(strcmp(redcap.R_activeGroup, 'D') | strcmp(redcap.L_activeGroup, 'D'));
% 
%     stimGroups.('s2 side 0mA side Off')         = {redcap(i_s2_one0mA_oneOff,:)};
