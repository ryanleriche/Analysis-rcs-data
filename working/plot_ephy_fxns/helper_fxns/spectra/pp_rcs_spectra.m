function pp_rcs_spectra(cfg, dirs, pt_side_id)
...
ft_freq_pp = ft_freq_mtm;


par_db_in = ft_freq_mtm.rcs.par_db;
...
ft_freq_pp.powspctrm       = ft_freq_mtm.powspctrm(i_off_0mA, : ,:);
...
writetable(ft_freq_pp.rcs.par_db, fullfile(source_dir, [pt_side_id, '_par_db.xlsx']));
end